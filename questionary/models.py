...
class Specification(models.Model):
    questionary = models.ForeignKey(Questionary,
                                    ...
                                    related_name='spec_questionary',
                                    null=True)
    categories = models.ManyToManyField(Tag, verbose_name='categories',
                                        related_name='questionary_categories',
                                        blank=False)
    n_questions = models.PositiveSmallIntegerField(_('Number of Questions'),
                                                   null=True)
...
class UserQuest(models.Model):
    questionary = models.ForeignKey(Questionary,
                                    verbose_name=_('Questionary'),
                                    related_name='userquest_questionary',
                                    null=True)
    student = models.ForeignKey(User, verbose_name=_('User'),
                                related_name='userquest_user', null=True)
...
class UserAnswer(models.Model):
    user_quest = models.ForeignKey(UserQuest,
                                   verbose_name=_('User Questionary'),
